...
export default function Home() {
  return <main className="bw-home">
    ...
    <section className="bw-portal-section"><div className="bw-portal-copy"><p>Your client portfolio</p><h2>A private view of<br />what matters.</h2><p>Portfolio value, approved deposits, current holdings, and account requests are organised in one secure place.</p><Link href="/sign-in">Enter client portal <b>↗</b></Link></div><div className="bw-portfolio-card"><header><span>CLIENT PORTAL</span><b>Portfolio overview</b><i>Private client</i></header><div className="bw-portfolio-value"><small>Total portfolio value</small><strong>$84,206.19</strong><span>▲ 4.80% <i>vs. previous period</i></span><svg className="bw-portfolio-chart" viewBox="0 0 380 90" role="img" aria-label="Illustrative upward portfolio performance chart"><path d="M0 74 C30 65 41 71 64 53 S104 59 126 42 S166 56 190 34 S226 41 250 23 S290 35 317 14 S353 22 380 4" fill="none" stroke="currentColor" strokeWidth="3" /><path d="M0 74 C30 65 41 71 64 53 S104 59 126 42 S166 56 190 34 S226 41 250 23 S290 35 317 14 S353 22 380 4 V90 H0Z" fill="url(#portfolio-fill)" /><defs><linearGradient id="portfolio-fill" x1="0" x2="0" y1="0" y2="1"><stop stopColor="currentColor" stopOpacity=".3" /><stop offset="1" stopColor="currentColor" stopOpacity="0" /></linearGradient></defs></svg></div><div className="bw-portfolio-list"><p>Holdings <small>Allocation</small></p><span><i className="dot-one" />Global equity portfolio <b>$40,419.00 <small>48%</small></b></span><span><i className="dot-two" />Bitcoin <b>$26,104.00 <small>31%</small></b></span><span><i className="dot-three" />Gold spot <b>$17,683.19 <small>21%</small></b></span></div></div></section>
