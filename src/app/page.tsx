...
export default function Home() {
  return <main className="bw-home">
    ...
    <section className="bw-portal-section"><svg className="bw-portfolio-growth-line" viewBox="0 0 1440 640" preserveAspectRatio="none" aria-hidden="true"><polyline points="-36,598 112,510 196,548 326,434 420,490 570,336 658,404 782,218 876,286 1032,126 1126,190 1210,245 1280,168 1395,42" fill="none" stroke="#076b49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="13" /><path d="M1284 129 L1395 42 L1365 160" fill="none" stroke="#076b49" strokeLinecap="round" strokeLinejoin="round" strokeWidth="13" /></svg><div className="bw-portal-copy"><p>Your client portfolio</p><h2>A private view of<br />what matters.</h2><p>Portfolio value, performance history, asset allocation, and current holdings come together in one secure client view.</p><Link href="/sign-in">Enter client portal <b>↗</b></Link></div><PortfolioPreview /></section>
