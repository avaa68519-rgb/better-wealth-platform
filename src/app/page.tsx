...
export default function Home() {
  return <main className="bw-home">
    ...
    <section className="bw-portal-section"><svg className="bw-portfolio-growth-line" viewBox="0 0 1440 640" preserveAspectRatio="none" aria-hidden="true"><polyline points="-32,610 148,520 246,568 392,470 486,526 650,376 742,438 872,268 962,324 1104,190 1200,246 1310,180 1388,86" fill="none" stroke="#075a35" strokeLinecap="square" strokeLinejoin="miter" strokeWidth="24" /><polygon points="1430,18 1338,52 1400,142" fill="#075a35" /></svg><div className="bw-portal-copy"><p>Your client portfolio</p><h2>A private view of<br />what matters.</h2><p>Portfolio value, performance history, asset allocation, and current holdings come together in one secure client view.</p><Link href="/sign-in">Enter client portal <b>↗</b></Link></div><PortfolioPreview /></section>
