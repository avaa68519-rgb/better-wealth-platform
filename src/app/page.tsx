...
export default function Home() {
  return <main className="bw-home">
    ...
    <section className="bw-portal-section"><svg className="bw-portfolio-growth-line" viewBox="0 0 1440 640" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="portfolio-growth" x1="0" x2="1" y1="1" y2="0"><stop stopColor="#139b69" stopOpacity=".42" /><stop offset="1" stopColor="#3bea9a" /></linearGradient></defs><polyline points="-36,598 112,510 196,548 326,434 420,490 570,336 658,404 782,218 876,286 1032,126 1126,190 1278,52" fill="none" stroke="url(#portfolio-growth)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="11" /><path d="M1208 61 L1278 52 L1261 119" fill="none" stroke="#3bea9a" strokeLinecap="round" strokeLinejoin="round" strokeWidth="11" /></svg><div className="bw-portal-copy"><p>Your client portfolio</p><h2>A private view of<br />what matters.</h2><p>Portfolio value, performance history, asset allocation, and current holdings come together in one secure client view.</p><Link href="/sign-in">Enter client portal <b>↗</b></Link></div><PortfolioPreview /></section>
