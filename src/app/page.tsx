...
export default function Home() {
  return <main className="bw-home">
    ...
    <section className="bw-portal-section"><svg className="bw-portfolio-growth-line" viewBox="0 0 1440 640" preserveAspectRatio="none" aria-hidden="true"><polyline points="-32,594 144,490 254,552 420,382 554,494 790,248 904,362 1102,154 1208,246 1324,112" fill="none" stroke="#075a35" strokeLinejoin="miter" strokeWidth="38" /><polygon points="1412,18 1248,82 1324,178" fill="#075a35" /></svg><div className="bw-portal-copy"><p>Your client portfolio</p><h2>A private view of<br />what matters.</h2><p>Portfolio value, performance history, asset allocation, and current holdings come together in one secure client view.</p><Link href="/sign-in">Enter client portal <b>↗</b></Link></div><PortfolioPreview /></section>
