  ...
  return (
    <main className="marketing-page detailed-home">
      ...
      <section className="hero">
        <div className="hero-copy"><p className="eyebrow">Better Wealth Investment Group</p><h1>Invest with <em>intention.</em></h1><p className="hero-lede">A considered investment experience for people who value perspective, transparent information, and a thoughtful long-term plan.</p><div className="hero-actions"><a className="button" href="#plans">Explore investment plans <span aria-hidden>→</span></a><a className="text-link" href="#markets">View market instruments</a></div><p className="risk-note">Capital is at risk. Investment values can rise and fall.</p></div>
        <div className="hero-art" aria-label="Abstract investment illustration"><div className="orb orb-one" /><div className="orb orb-two" /><div className="grid-line line-one" /><div className="grid-line line-two" /><div className="hero-card"><span>Portfolio overview</span><strong>$84,206.19</strong><b>↑ 4.8% <i>this month</i></b></div><div className="art-caption"><span className="caption-dot" /> Long-term perspective</div></div>
      </section>
