...
export default function FundingPage() {
  ...
  async function loadFundingData() {
    ...
    setMessage(assignedAddresses.length ? "" : "No deposit wallet has been assigned to your account yet. Contact Better Wealth support when you are ready to fund.");
  }
  ...
  async function submitDeposit(event: FormEvent<HTMLFormElement>) {
    ...
    navigator.vibrate?.(35); event.currentTarget.reset(); setMessage("✓ Deposit reference confirmed. It is now awaiting Better Wealth review, and an email confirmation is on its way."); await loadFundingData();
  }
  ...
  async function submitWithdrawal(event: FormEvent<HTMLFormElement>) {
    ...
    navigator.vibrate?.(35); event.currentTarget.reset(); setMessage("✓ Withdrawal request confirmed. It is now awaiting manual review, and an email confirmation is on its way."); await loadFundingData();
  }
