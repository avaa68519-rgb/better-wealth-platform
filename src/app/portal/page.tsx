...
type Holding = { id: string; asset_name: string; asset_symbol: string; units: number; unit_price: number };
...
export default function PortalOverview() {
  ...
  useEffect(() => {
    void (async () => {
      ...
      const holdingResult = accountIds.length ? await supabase.from("holdings").select("id, asset_name, asset_symbol, units, unit_price").in("portfolio_account_id", accountIds) : { data: [], error: null };
